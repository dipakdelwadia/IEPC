...
namespace WebAPI.Infrastructure.Repositories
{
    ...
    public class ReportRepository : IReportRepository
    {
        ...
        private static string GetFormCodeByReportName(string reportName)
        {
            ...
            {
                "PV Inventory" => "IEPC-PVINVEAL",
                "PP Inventory" => "IEPC-PPINVEAL",
                "TK Inventory" => "IEPC-TKINVEAL",
                ...
                "Facility" => "IEPC-FS",
                "System List" => "IEPC-SHS",
                "PV Scheduler Report" => "IEPC-PVINVEAL",
                "PP Scheduler Report" => "IEPC-PPINVEAL",
                "TK Scheduler Report" => "IEPC-TKINVEAL",
                "PV CML Audit Report" => "IEPC-PVINVEAL",
                "PP CML Audit Report" => "IEPC-PPINVEAL",
                "TK CML Audit Report" => "IEPC-TKINVEAL",

                //"PRD Audit Report" => "IEPC-PRDAUDIT",
                //"PRD Findings Report" => "IEPC-PRDFIN",
                _ => "IEPC-" + reportName.Split(' ')[0] + "INVEAL"
            };
        }
